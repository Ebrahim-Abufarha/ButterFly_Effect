...
import usFlag from '/img/icons/flags/US.png';
import deFlag from '/img/icons/flags/DE.png';
import gbFlag from '/img/icons/flags/GB.png';
import brFlag from '/img/icons/flags/BR.png';

function DashboardAdmin() {
  return (
        <div className="w-full px-6 py-6 mx-auto">

                 <div className="w-full px-6 py-6 mx-auto"></div>
          ...
          <tbody>
            ...
            <tr>
              <td className="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                <div className="flex items-center px-2 py-1">
                  <div>
                    <img src={deFlag} alt="Country flag" />
                  </div>
                  <div className="ml-6">
                    <p className="mb-0 text-xs font-semibold leading-tight dark:text-white dark:opacity-60">Country:</p>
            ...
            <tr>
              <td className="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                <div className="flex items-center px-2 py-1">
                  <div>
                    <img src={gbFlag} alt="Country flag" />
                  </div>
                  <div className="ml-6">
                    <p className="mb-0 text-xs font-semibold leading-tight dark:text-white dark:opacity-60">Country:</p>
            ...
            <tr>
              <td className="p-2 align-middle bg-transparent border-0 w-3/10 whitespace-nowrap">
                <div className="flex items-center px-2 py-1">
                  <div>
                    <img src={brFlag} alt="Country flag" />
                  </div>
                  <div className="ml-6">
                    <p className="mb-0 text-xs font-semibold leading-tight dark:text-white dark:opacity-60">Country:</p>
